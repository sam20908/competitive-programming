...
template <typename T>
struct is_bitset : public false_type
{
};
template <size_t N>
struct is_bitset<bitset<N>> : public true_type
{
};
...
template <typename T, typename = void>
struct is_tuple_like : public false_type
{
};
template <typename T>
struct is_tuple_like<T, void_t<typename tuple_size<T>::type>> : public true_type
{
};
