 ...
 */
 ...
 struct segment_tree {
   ...
   F query_fn;
   /**
    * @brief Construct a new segment tree and builds each node.
    *
    * @param n Size of the segment tree to be represented.
    * @param v Default value for leaf nodes.
    * @param apply Returns the updated value of a segment tree leaf node. Called as `fn(v, *update-args*)`.
    ...
    * @param args Additional arguments for `query_combine`.
